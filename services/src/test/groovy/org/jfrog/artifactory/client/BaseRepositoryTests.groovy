...
import org.jfrog.artifactory.client.model.impl.ContentSynchronisationImpl
...
public abstract class BaseRepositoryTests extends ArtifactoryTestsBase {
    ...
    protected void setUp() {
        ...
        if(prepareRemoteRepo) {
            ContentSynchronisation smartSettings = new ContentSynchronisationImpl();
            remoteRepo = artifactory.repositories().builders().remoteRepositoryBuilder()
                ...
                .repositorySettings(settings)
                .xraySettings(xraySettings)
                .contentSynchronisation(smartSettings)
                .build()
        }
