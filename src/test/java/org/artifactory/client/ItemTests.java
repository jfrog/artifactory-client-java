 ...
 * @since 03/08/12
 */
public class ItemTests extends ArtifactoryTests{
    ...
    public void testFileInfo() {
        ...
        assertEquals(file.getDownloadUri(), "http://clienttests.artifactoryonline.com/clienttests/repo1-cache/junit/junit/4.10/junit-4.10-sources.jar");
